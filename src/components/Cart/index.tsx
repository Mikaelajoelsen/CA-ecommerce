                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                    ...
                    <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                      ...
                      <div className="mt-6">
                        <button
                          onClick={clearCart}
                          className="flex items-center justify-center rounded-md border border-transparent bg-red-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 w-full"
                        >
                          Clear Cart
                        </button>
                      </div>
